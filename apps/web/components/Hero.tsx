...
const Hero = () => {
  return (
    <header className={`w-full relative bg-[url(${Pattern})] bg-cover bg-bottom-right flex flex-col items-center gap-y-14 py-6 sm:py-10 md:py-20 px-4 sm:px-8 overflow-hidden z-0`}>
