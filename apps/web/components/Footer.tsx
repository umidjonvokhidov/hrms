          ...
          <div className="w-full flex flex-col md:flex-row justify-between items-start gap-4 md:items-center border-t border-gray-50 pt-4 md:pt-6">
            ...
            <div className="flex items-center gap-5">
              <Link href={"facebook.com"} className="group">
                <FacebookIcon className="group-hover:text-primary text-white size-6 transition-colors"/>
              </Link>
              <Link href={"instagram.com"} className="group">
                <InstagramIcon className="group-hover:text-primary text-white size-6 transition-colors"/>
              </Link>
              <Link href={"x.com"} className="group">
                <XIcon className="group-hover:text-primary text-white size-6 transition-colors"/>
              </Link>
            </div>
          </div>
        </div>
